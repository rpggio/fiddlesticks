...
(function (SketchEditor) {
    var WorkspaceController = (function () {
        ...
        WorkspaceController.prototype.downloadPNG = function () {
            var data = this.getSnapshotPNG(72);
