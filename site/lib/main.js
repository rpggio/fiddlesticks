        ...
        function Builder(container, store) {
            var context = {
                ...
                createFontChooser: function () {
                    return new SketchBuilder.DesignFontChooser(store);
                }
            };
...
(function (SketchBuilder) {
    var Chooser = (function () {
        function Chooser(factory) {
            this._value$ = new Rx.Subject();
            this.factory = factory;
        }
        Object.defineProperty(Chooser.prototype, "value$", {
            get: function () {
                return this._value$;
            },
            enumerable: true,
        ...
        Chooser.prototype.createNode = function (choices, value) {
            var _this = this;
            return h("ul.chooser", {}, choices.map(function (choice) {
                var choiceNode = _this.factory(choice);
                return h("li.choice", {
                    class: {
...
var SketchBuilder;
(function (SketchBuilder) {
    var DesignFontChooser = (function () {
        function DesignFontChooser(store) {
            this._fontChooser = new SketchBuilder.FontChooser(store);
            this._fontChooser.maxChoices = 12;
        }
        DesignFontChooser.prototype.createNode = function (value) {
        ...
        Object.defineProperty(DesignFontChooser.prototype, "value$", {
            get: function () {
        ...
        return DesignFontChooser;
    }());
    SketchBuilder.DesignFontChooser = DesignFontChooser;
})(SketchBuilder || (SketchBuilder = {}));
var SketchBuilder;
(function (SketchBuilder) {
    var FontChooser = (function () {
        function FontChooser(store) {
            this.maxChoices = Number.MAX_VALUE;
            this.store = store;
            var stringAsDiv = function (s) { return h("div", {}, [s]); };
            this.categoryChooser = new SketchBuilder.Chooser(stringAsDiv);
            this.familyChooser = new SketchBuilder.Chooser(stringAsDiv);
            this.variantChooser = new SketchBuilder.Chooser(stringAsDiv);
        }
        Object.defineProperty(FontChooser.prototype, "value$", {
            get: function () {
                return Rx.Observable.combineLatest(this.categoryChooser.value$.startWith(null), this.familyChooser.value$.startWith(null), this.variantChooser.value$.startWith(null), function (category, family, variant) {
                    return { category: category, family: family, variant: variant };
                }).skip(1);
            },
            enumerable: true,
            configurable: true
        ...
        FontChooser.prototype.createNode = function (value) {
            ...
            children.push(this.categoryChooser.createNode(this.store.fontCatalog.getCategories(), value.category));
            if (value.category) {
                var families = this.store.fontCatalog.getFamilies(value.category);
                if (this.maxChoices) {
                    families.length = this.maxChoices;
                }
                children.push(h("h3", {}, ["Families"]));
                children.push(this.familyChooser.createNode(families, value.family));
            }
            if (value.family) {
                var variants = this.store.fontCatalog.getVariants(value.family);
                if (variants.length > 1) {
                    children.push(h("h3", {}, ["Variants"]));
                    children.push(this.variantChooser.createNode(variants, value.variant));
                }
            }
