                            ...
                            return h("img", {
                                hook: {
                                    insert: function (vnode) {
                                        ...
                                        context.renderDesign(null, function (dataUrl) {
                    ...
                    return [
                        {
                            ...
                            loadImage: function (el) {
                                ...
                                context.renderDesign({ shape: "narow" }, function (dataUrl) {
                                    el.src = dataUrl;
                                });
                            }
                        },
                        {
                            ...
                            loadImage: function (el) {
                                ...
                                context.renderDesign({ shape: "wide" }, function (dataUrl) {
                                    el.src = dataUrl;
                                });
                            }
                        }
