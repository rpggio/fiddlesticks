...
declare module paper {
    ...
    */
    ...
    export class Segment {
        ...
        /**
         * Smooths the bezier curves that pass through this segment.
         */
        smooth(options?: paper.SmoothOptions): void;

    }
    
    /**
     * Options for Segment.smooth
     */
    export interface SmoothOptions {
        /**
         * The type of smoothing method: ‘catmull-rom’, ‘geometric’ 
         * default: ‘catmull-rom’
         */
        type: string;
        
        /**
         * The factor parameterizing the smoothing method.
         * default: 0.5 for 'catmull-rom', 0.4 for 'geometric'
         */
        factor: number;
    }
