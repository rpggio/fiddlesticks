...
var WorkspaceController = (function () {
    function WorkspaceController(channels, font) {
        ...
        var textWarp = new TextWarp(font, "FLOOFY", { fillColor: "green", strokeColor: "gray", fontSize: 128 });
...
var DualBoundsPathWarp = (function (_super) {
    ...
    function DualBoundsPathWarp(source, bounds) {
        var _this = this;
        _super.call(this);
        // -- build children --
        this._source = source;
...
var TextWarp = (function (_super) {
    ...
    function TextWarp(font, text, style) {
        var pathData = TextWarp.getPathData(font, text, style && style.fontSize);
    ...
    Object.defineProperty(TextWarp.prototype, "style", {
        get: function () {
    ...
    TextWarp.prototype.updateTextPath = function () {
        this._textPath.pathData = TextWarp.getPathData(this._font, this._text, this._textPath.style.fontSize);
    };
    TextWarp.getPathData = function (font, text, fontSize) {
        var openTypePath = font.getPath(text, 0, 0, Number(fontSize) || TextWarp.DEFAULT_FONT_SIZE);
        return openTypePath.toPathData();
    };
    TextWarp.DEFAULT_FONT_SIZE = 32;
    return TextWarp;
}(DualBoundsPathWarp));
